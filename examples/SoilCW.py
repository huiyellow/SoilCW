...
class SoilCW(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "SoilCW")
        ...
        self.blocks_multiply_const_xx_0 = blocks.multiply_const_cc(1/burst_len, 1)
        self.blocks_integrate_xx_0 = blocks.integrate_cc(burst_len, 1)
        self.blocks_divide_xx_0 = blocks.divide_cc(1)
        self.blocks_complex_to_magphase_0 = blocks.complex_to_magphase(1)
        self.SoilCW_soil_cw_radar_cc_0 = SoilCW.soil_cw_radar_cc(int(main_freq), int(delta_f), int(samp_rate), int(rx_gain), int(tx_gain), int(ref_gain), False, pulse_amp, cw_freq)
        ...
        self.connect((self.blocks_divide_xx_0, 0), (self.blocks_integrate_xx_0, 0))
        self.connect((self.blocks_integrate_xx_0, 0), (self.blocks_multiply_const_xx_0, 0))
        self.connect((self.blocks_multiply_const_xx_0, 0), (self.blocks_complex_to_magphase_0, 0))
        self.connect((self.filter_fft_low_pass_filter_0, 0), (self.blocks_divide_xx_0, 0))
        self.connect((self.filter_fft_low_pass_filter_0_0, 0), (self.blocks_divide_xx_0, 1))
    ...
    def set_burst_len(self, burst_len):
        ...
        self.blocks_multiply_const_xx_0.set_k(1/self.burst_len)




def main(top_block_cls=SoilCW, options=None):
